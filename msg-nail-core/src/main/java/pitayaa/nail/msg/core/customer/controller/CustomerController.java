...
public class CustomerController {
	...
	public @ResponseBody ResponseEntity<?> createCustomer(
		...
		return new ResponseEntity<Resource<Customer>>(response,
				HttpStatus.CREATED);
	}

	@RequestMapping(value = "customers/{ID}", method = RequestMethod.PUT)
	public @ResponseBody ResponseEntity<?> createCustomer(
			@RequestBody Customer customerBody, @PathVariable("ID") UUID id)
			throws Exception {
		...
		return new ResponseEntity<Resource<Customer>>(response, HttpStatus.OK);
	}
